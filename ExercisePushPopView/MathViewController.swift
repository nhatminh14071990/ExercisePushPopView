...
class MathViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Timer.scheduledTimer(timeInterval: 1.0, target: self, selector: #selector(MathViewController.updateTime), userInfo: nil, repeats: true)
    }
    ...
    func generaNumber(){
        ...
        if(calculationCurrent == "-"){//neu la phep tru: num1 >= num2
        ...
        }else if(calculationCurrent == "/"){//neu la phep chia: num2 != 0 && num1 % num2 == 0
            ...
            repeat{
                ...
                randomNum2 = Float32(results[1])
            }while(randomNum2 == 0 || Int(randomNum1) % Int(randomNum2) != 0)
